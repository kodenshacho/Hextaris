...
function renderBeginningText() {
	...
	renderText((trueCanvas.width)/2 + 1.5 * settings.scale, (trueCanvas.height)/2 - 160 * settings.scale, 20, '#2c3e50', 'Tap the left or right side to rotate the Hexagon!', '20px Roboto');

	renderText((trueCanvas.width)/2 + 1.5 * settings.scale, (trueCanvas.height)/2 - 125 * settings.scale, 20, '#2c3e50', 'Try to combine 3+ touching blocks of the same color!', '20px Roboto');
	...
	renderText((trueCanvas.width)/2 + 1.5 * settings.scale, (trueCanvas.height)/2 - 90 * settings.scale, 20, '#2c3e50', 'Don\'t let the blocks stack outside of the gray Hexagon!', '20px Roboto');
}
